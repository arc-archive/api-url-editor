 ...
 */
declare class ApiUrlEditor extends
  EventsTargetMixin(
  ValidatableMixin(
  LitElement)) {
  readonly styles: any;
  readonly inputElement: AnypointInput|null;
   ...
   */
  _computeQueryItems(params: Map|null): Array<ParamsObject|null>|null;
   ...
   * @returns .
   */
  _wwwFormUrlEncode(object: Array<ParamsObject|null>|null): string;
   ...
   */
  _computeUrlRegexp(url: String|null): RegExp|null;
